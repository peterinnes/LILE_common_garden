...
# FIG S5 
jpeg("plots/figS5_env_pca.jpg", width=17, height=11.5, res=600, units="cm")
env_pca_plot
dev.off()
...
# Fig S6
figS6 <- plot_grid(mv_trd_plot, eph_trd_plot,
                   labels=c("a)","b)"),
                   ncol=1, nrow=2) 
jpeg(file="plots/figS6_env_PC_transfer_distance.jpg",
